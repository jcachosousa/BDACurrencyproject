...
Business Decisions
---------------------------------------------------------
Assuming I am a Global Potfolio Manager and have limited currency forwards available to hedge my portfolio, with the decomposition of principal components in currency price changes agaist USD I want to group countries in a way that my global portfolio could be more efficiently hedged with few currencies (around 4 in the example below). 


The Data
--------------------------------------------------------------
We got from Bloomberg currency data for all the major currencies in the world against the USD in the last 30 days (short term)
