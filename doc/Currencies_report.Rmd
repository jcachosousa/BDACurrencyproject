...
The Data
--------------------------------------------------------------
We got from Bloomberg currency data for all the mjor currencies in the world against the USD in the last 30 days (short term)
...
Our Approach
---------------------------------------------------
We did the 6 step analysis as suggested by the course
...
we used prices instead of returns 
...
we assumed 4 currencies is a reasonable assumption for portfolio hedging
